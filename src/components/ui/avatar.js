...
const Avatar = React.forwardRef(({ className, ...props }, ref) => (_jsx(AvatarPrimitive.Root, { ref: ref, className: cn("relative flex h-[35px] w-[35px] shrink-0 overflow-hidden rounded-full", className), ...props })));
